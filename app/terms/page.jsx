    ...
    <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            By accessing or using SlotSphere&apos;s scheduling platform, you agree to be bound by these Terms of Service and
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Subject to your compliance with these Terms, SlotSphere grants you a limited, non-exclusive,
            non-transferable, revocable license to access and use our platform for your personal or business scheduling
            needs.
          </p>
          <p>You may not:</p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>Modify or copy the materials except as necessary for your personal use of the platform</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Our platform allows you to create and share content, such as scheduling information, event details, and
            communications with meeting participants. You retain all rights to your content, but you grant SlotSphere a
          ...
          <p>
            You represent and warrant that you own or have the necessary rights to your content and that your content
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              Using the platform for any illegal purpose or in violation of any local, state, national, or international
              law
            </li>
            <li>Harassing, abusing, or harming another person</li>
            <li>Impersonating another user or person</li>
            <li>Using the platform in a manner that could disable, overburden, damage, or impair the site</li>
            <li>Using any robot, spider, or other automatic device to access the platform</li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            SlotSphere offers both free and paid subscription plans. By selecting a paid subscription, you agree to pay
            all fees in accordance with the pricing and terms displayed to you at the time of purchase.
          </p>
          <p className="mb-4">
          ...
          <p>
            All subscription fees are non-refundable except as required by law or as explicitly stated in these Terms.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            In no event shall SlotSphere, its directors, employees, partners, agents, suppliers, or affiliates be liable
